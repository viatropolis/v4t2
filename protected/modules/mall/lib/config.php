...
define('AJAX_CHAT_VIP',			-1);
// AJAX Chat config parameters:
$config = array();

// define base URL path
$config['baseUrlPath'] = Yii::app()->getModule("mall")->assetsUrl."/";
...
// Database username:
$config['dbConnection']['user'] = Yii::app()->db->username;
// Database password:
$config['dbConnection']['pass'] = Yii::app()->db->password;
// Database name:
$config['dbConnection']['name'] = 'viatrop_ajaxchat2';
// Database type:
...
// Available styles:
$config['styleAvailable'] = array('drag0n');
// Default style:
$config['styleDefault'] = 'Viatropolis';
...
$config['sessionName'] = 'dragonsinn_chat';
// Prefix added to every session key:
$config['sessionKeyPrefix'] = 'dragonsinnChat';
...
$config['defaultChannelName'] = 'Viatropolis';
...
$config['chatBotName'] = 'Viatropolis';
...
// Max userName length:
$config['userNameMaxLength'] = 1000;
// Max messageText length:
$config['messageTextMaxLength'] = 1000000;
// Defines the max number of messages a user may send per minute:
$config['maxMessageRate'] = 7;
...
$config['logoutData'] = Yii::app()->createUrl("/Viatropolis");
